...
class TabelaVoluntarios(db: SQLiteDatabase) {
    ...
    fun cria() {
        db.execSQL("CREATE TABLE $NOME_TABELA (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $CAMPO_NOME TEXT NOT NULL, $CAMPO_DATA_NASCIMENTO NUMBER NOT NULL, $CAMPO_TELEFONE NUMBER NOT NULL, $CAMPO_GENERO TEXT NOT NULL)")
    }
