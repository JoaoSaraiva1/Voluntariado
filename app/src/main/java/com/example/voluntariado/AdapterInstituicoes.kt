...
class AdapterInstituicoes(val fragment: ListaInstituicoesFragment) : RecyclerView.Adapter<AdapterInstituicoes.ViewHolderInstituicao>() {
     ...
     */
    override fun onBindViewHolder(holder: ViewHolderInstituicao, position: Int) {
